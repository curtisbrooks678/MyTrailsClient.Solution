        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserTrails_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivityLevel = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    Bounty = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    Latitude = table.Column<double>(type: "double", nullable: false),
                    Longitude = table.Column<double>(type: "double", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisitEntries", x => x.VisitEntryId);
                    table.ForeignKey(
                        name: "FK_VisitEntries_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "UserTrailVisitEntry",
                columns: table => new
                {
                    UserTrailVisitEntryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    UserTrailId = table.Column<int>(type: "int", nullable: false),
                    VisitEntryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTrailVisitEntry", x => x.UserTrailVisitEntryId);
                    table.ForeignKey(
                        name: "FK_UserTrailVisitEntry_UserTrails_UserTrailId",
                        column: x => x.UserTrailId,
                        principalTable: "UserTrails",
                        principalColumn: "UserTrailId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserTrailVisitEntry_VisitEntries_VisitEntryId",
                        column: x => x.VisitEntryId,
                        principalTable: "VisitEntries",
                        principalColumn: "VisitEntryId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTrails_UserId",
                table: "UserTrails",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserTrailVisitEntry_UserTrailId",
                table: "UserTrailVisitEntry",
                column: "UserTrailId");

            migrationBuilder.CreateIndex(
                name: "IX_UserTrailVisitEntry_VisitEntryId",
                table: "UserTrailVisitEntry",
                column: "VisitEntryId");

            migrationBuilder.CreateIndex(
                name: "IX_VisitEntries_UserId",
                table: "VisitEntries",
                column: "UserId");
        }
